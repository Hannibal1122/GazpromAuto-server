<?php 
	...
	$_main = array(
		...
		"data" => array(
            ...
            $_PATH."src/app/editor-big-table/editor-big-table.component.css",
			$_PATH."src/app/editor-big-table/editor-big-table.component.html",
            $_PATH."src/app/editor-big-table/editor-big-table.component.ts",
			$_PATH."src/app/enter/enter.component.css",
			$_PATH."src/app/enter/enter.component.html",
            $_PATH."src/app/enter/enter.component.ts",
            $_PATH."src/app/events/events.component.css",
			$_PATH."src/app/events/events.component.html",
            $_PATH."src/app/events/events.component.ts",
            ...
            $_PATH."src/app/tasks/tasks.component.css",
			$_PATH."src/app/tasks/tasks.component.html",
            $_PATH."src/app/tasks/tasks.component.ts",
            ...
            $_PATH."src/app/type/type.component.css",
			$_PATH."src/app/type/type.component.html",
            $_PATH."src/app/type/type.component.ts",
